    ...
    <div class="grid md:h-screen md:grid-cols-2">
      ...
      <div class="flex flex-col items-center justify-center bg-sla">
        ...
        <div class="max-w-lg px-5 py-16 text-center md:px-10 md:py-24 lg:py-32">
          <!-- Title -->
          <h2 class="mb-8 text-3xl font-bold md:mb-12 md:text-2xl">Welcome to BTP Kecermatan</h2>
          <!-- Form -->
          <form action="<?= base_url() ?>/login/checklogin" method="post" class="mx-auto mb-4 max-w-sm pb-4" name="wf-form-password">
            <div class="relative">
