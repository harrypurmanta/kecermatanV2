...
<?= $this->include('admin/sidebar') ?>
     ...
     <div class="flex-1 p-3 border">
        ...
        <div class="bg-three mt-2">
          <form class="p-4 md:p-5">
            <div class="grid gap-4 mb-4 grid-cols-2">
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength='5' onkeyup="checkdupe('kolom1')" oninput="this.value = this.value.toUpperCase()" value="<?= ($soal != null ? $soal[0]->clue:"") ?>" type="text" name="kolom1" id="kolom1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Soal" required="">
                </div>
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength='5' onkeyup="checkdupe('kolom2')" oninput="this.value = this.value.toUpperCase()" value="<?= ($soal != null ? $soal[1]->clue:"") ?>" type="text" name="kolom2" id="kolom2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Soal" required="">
                </div>
                ...
                <div class="col-span-2 sm:col-span-1">
                  ...
                  <input onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength='5' onkeyup="checkdupe('kolom3')" oninput="this.value = this.value.toUpperCase()" value="<?= ($soal != null ? $soal[2]->clue:"") ?>" type="text" name="kolom3" id="kolom3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Soal" required="">
              </div>
              ...
              <div class="col-span-2 sm:col-span-1">
                ...
                <input onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength='5' onkeyup="checkdupe('kolom4')" oninput="this.value = this.value.toUpperCase()" value="<?= ($soal != null ? $soal[3]->clue:"") ?>" type="text" name="kolom4" id="kolom4" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Soal" required="">
            </div>
          ...
          <div class="col-span-2 sm:col-span-1">
            ...
            <input onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength='5' onkeyup="checkdupe('kolom6')" oninput="this.value = this.value.toUpperCase()" value="<?= ($soal != null ? $soal[5]->clue:"") ?>" type="text" name="kolom6" id="kolom6" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Soal" required="">
        </div>
        ...
        <div class="col-span-2 sm:col-span-1">
          ...
          <input onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength='5' onkeyup="checkdupe('kolom7')" oninput="this.value = this.value.toUpperCase()" value="<?= ($soal != null ? $soal[6]->clue:"") ?>" type="text" name="kolom7" id="kolom7" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Soal" required="">
      </div>
    ...
    <div class="col-span-2 sm:col-span-1">
      ...
      <input onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength='5' onkeyup="checkdupe('kolom9')" oninput="this.value = this.value.toUpperCase()" value="<?= ($soal != null ? $soal[8]->clue:"") ?>" type="text" name="kolom9" id="kolom9" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Soal" required="">
    </div>
      <div class="col-span-2 sm:col-span-1">
          ...
          <input onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength='5' onkeyup="checkdupe('kolom10')" oninput="this.value = this.value.toUpperCase()" value="<?= ($soal != null ? $soal[9]->clue:"") ?>" type="text" name="kolom10" id="kolom10" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Soal" required="">
      </div>
