...
<!-- sidebar -->
  <?= $this->include('front/sidebar') ?>
        ...
        <div class="flex-1 items-center p-3 text-xl bg-slate-100" >
          ...
          <div>
            <h1 id="lb_kolom" class="mb-4 mt-8 font-semibold text-two bg-orange-200 text-center w-[128px] rounded-lg shadow-md px-4 py-2 mx-auto">Kolom 1</h1>
